...
update_agent_file() {
    ...
    if [ ! -f "$target_file" ]; then
        ...
        if [ -f "~/bag/spec-driven-development/templates/agent-file-template.md" ]; then
            cp "~/bag/spec-driven-development/templates/agent-file-template.md" "$temp_file"
        else
            echo "ERROR: Template not found at ~/bag/spec-driven-development/templates/agent-file-template.md"
            return 1
        fi
