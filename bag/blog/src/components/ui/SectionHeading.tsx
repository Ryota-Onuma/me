export const SectionHeading = ({
    ...
    return (
        <div className="relative mb-16 md:mb-24">
            <div className="absolute -top-12 md:-top-24 left-0">
                <h2 className="text-7xl sm:text-9xl md:text-[18rem] font-black tracking-[-0.08em] italic uppercase text-white/[0.03] select-none leading-none pointer-events-none whitespace-nowrap">
