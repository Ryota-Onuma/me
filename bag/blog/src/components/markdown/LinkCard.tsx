    ...
    return (
        <div className="not-prose my-10">
            <a
                ...
                className="group flex flex-row border border-black/10 rounded-3xl overflow-hidden bg-white transition-all duration-500 hover:shadow-2xl hover:border-black/20 hover:-translate-y-1 max-w-2xl h-36 md:h-40 relative"
            >
